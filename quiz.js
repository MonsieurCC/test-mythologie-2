...
const PAIR_RESULTS = {
  ...
  "Créatif->Séducteur": {
    ...
    conclusion: "Dans la mythologie grecque, Éros est une force primordiale avant d’être un personnage. Il ne conquiert pas par l’épée, ne règne pas par la loi et ne brille pas par la parole. Il agit autrement. Par une flèche, une impulsion invisible ou un désir soudain, il fait naître ce qui n’existait pas auparavant : l’attachement, la passion, le bouleversement intérieur. Éros n’est presque jamais le héros des récits, mais il en est souvent l’origine secrète. Son mythe raconte le pouvoir de l’invisible, celui qui transforme le destin des autres sans jamais chercher la reconnaissance directe.\n\nLe profil créatif et séducteur trouve en Éros une figure profondément cohérente. Sa créativité ne passe pas par des œuvres matérielles, mais par l’invention de situations émotionnelles inédites. Avant Éros, les personnages sont immobiles ; après lui, ils aiment, doutent et se transforment. Créer, pour Éros, signifie provoquer un mouvement intérieur. Le séducteur, chez lui, n’est pas celui qui se montre, mais celui qui influence. Il tire son énergie de l’intensité qu’il fait naître chez les autres. Comme le participant qui partage ce profil, Éros existe pleinement à travers l’impact qu’il a sur les histoires plutôt qu’à travers sa visibilité.\n\nPsychologiquement, ce profil repose sur une extroversion émotionnelle indirecte. La personne créative-séductrice est stimulée par le lien, la réaction et la transformation qu’elle provoque chez autrui. Elle observe, ressent puis agit de manière ciblée. Elle aime éveiller, orienter et déclencher sans nécessairement s’exposer. Cette créativité stratégique permet d’ouvrir des possibles là où tout semblait figé. Comme Éros, ce profil préfère souvent l’ombre à la lumière, non par retrait, mais parce que sa satisfaction se trouve dans l’effet produit plutôt que dans l’applaudissement.\n\nLes forces de ce profil se manifestent clairement dans la vie quotidienne. En amitié, la personne est stimulante, inspirante et capable de provoquer des prises de conscience. En amour, elle crée une intensité forte, un sentiment d’unicité et parfois de fascination. Elle sait toucher là où cela compte. En carrière, ce profil s’épanouit dans les domaines où l’influence, la créativité relationnelle et la compréhension des dynamiques humaines sont centrales : communication, création, stratégie, médiation, arts ou accompagnement. Sa capacité à déclencher des mouvements sans imposer est une force rare.\n\nCependant, ce profil comporte aussi des fragilités. Influencer sans être vu peut mener à un sentiment d’effacement ou de solitude. Comme Éros, souvent invisible, la personne peut avoir l’impression que son rôle est minimisé ou incompris. Le besoin d’intensité peut également devenir une dépendance, poussant à rechercher constamment des émotions fortes au détriment de la stabilité. Le danger n’est pas l’influence, mais le fait de se définir uniquement par l’effet produit sur les autres en oubliant ses propres besoins.\n\nLa symbolique d’Éros est profondément éducative. L’arc et la flèche représentent une création intentionnelle : Éros choisit quand, comment et qui sera touché. Rien n’est laissé au hasard. Cette symbolique rappelle que créer des émotions est un acte puissant qui engage une responsabilité. L’invisibilité d’Éros montre que l’impact le plus fort n’est pas toujours celui qui se voit, mais elle invite aussi à ne pas se cacher éternellement derrière l’ombre.\n\nLa morale du mythe d’Éros invite le participant à reconnaître la valeur de son pouvoir créatif. Créer de l’intensité et influencer les histoires est un don, mais ce don demande une conscience de soi. Le participant est invité à apprendre d’Éros en développant une reconnaissance intérieure indépendante du regard extérieur. Être vu ne signifie pas nécessairement être exposé, mais savoir reconnaître sa propre valeur dans ce que l’on a déclenché. En équilibrant créativité, influence et responsabilité émotionnelle, le séducteur devient un véritable créateur de sens. Éros enseigne que l’on peut transformer des vies sans être le héros du récit, à condition de rester conscient de la puissance de ce que l’on provoque.",
  },
  "Créatif->Libre": {
    figure: "Dionysos",
  ...
  "Séducteur->Créatif": {
    figure: "Muses",
    image: "images/figures/muses.png",
    tagline: "Au centre de la scène pour partager du talent.",
    conclusion: "Dans la mythologie grecque, les Muses sont des figures qui ne passent jamais inaperçues. Elles apparaissent sur les hauteurs, sur les scènes, dans les récits, et attirent naturellement l’attention. Leur présence capte le regard, suspend l’écoute et impose le silence autour d’elles. Les Muses existent pour être vues, entendues et reconnues. Mais leur pouvoir ne repose pas sur une provocation vide. Il repose sur ce qu’elles incarnent. Elles sont la source de l’inspiration, de l’art et du talent. Leur mythe raconte que certaines figures ont pour rôle fondamental d’attirer l’attention afin d’éveiller quelque chose chez les autres.\n\nLe profil séducteur et créatif trouve dans les Muses une incarnation particulièrement juste. La séduction est première : les Muses aiment être au centre, nourries par le regard et la reconnaissance. Être vues n’est pas un caprice, mais une nécessité vitale. Cependant, cette séduction n’est jamais gratuite. Elle est soutenue par la créativité. Les Muses ne demandent pas l’attention sans raison : elles la méritent. Leur talent donne un sens à leur visibilité. Comme le participant qui partage ce profil, elles comprennent instinctivement que séduire sans substance ne suffit pas.\n\nPsychologiquement, ce profil repose sur une extroversion assumée. La personne séductrice-créative se sent vivante dans le lien, dans la réaction des autres et dans l’échange d’émotions. Elle a besoin d’être vue pour se sentir exister pleinement. Mais contrairement à une simple recherche de validation, ce besoin s’accompagne d’une exigence intérieure. La créativité devient un support identitaire : créer permet de justifier la présence sur la scène. Comme les Muses, ce profil sait que l’attention engage une responsabilité.\n\nLes forces de ce profil sont très visibles dans la vie quotidienne. En amitié, la personne est expressive, charismatique et capable de rassembler autour d’elle. Elle crée du mouvement, de l’énergie et de l’enthousiasme. En amour, elle est magnétique, démonstrative et intense, cherchant une relation nourrie par l’admiration mutuelle. En carrière, ce profil s’épanouit dans les domaines où la présence, la performance et la créativité sont liées : arts de la scène, communication, enseignement, animation, leadership créatif. Cette personne n’occupe pas l’espace par hasard, elle le fait vivre.\n\nCependant, ce profil comporte aussi des fragilités importantes. Le besoin d’être vu peut devenir envahissant lorsque l’attention se fait rare. La personne peut alors douter de sa valeur ou craindre l’oubli. Comme les Muses sans auditoire, elle peut se sentir inutile sans regard extérieur. Le risque est de confondre reconnaissance et amour, visibilité et légitimité. La créativité peut alors devenir un moyen de retenir l’attention plutôt qu’un élan authentique. Le danger n’est pas la séduction, mais la dépendance au regard des autres.\n\nLa symbolique des Muses est profondément éducative. Elles montrent que la séduction peut être noble lorsqu’elle s’appuie sur le talent. Elles n’arrachent pas la lumière : elles l’attirent par ce qu’elles incarnent. Mais leur mythe rappelle aussi que la scène n’existe que dans l’échange. Les Muses inspirent les autres à créer, à prendre la parole et à monter sur scène à leur tour. Leur séduction ouvre un espace collectif, elle ne le confisque pas.\n\nLa morale du mythe des Muses invite le participant à assumer son désir d’être vu sans le culpabiliser, tout en le reliant à une exigence intérieure. Vouloir attirer l’attention n’est pas un défaut lorsque l’on a quelque chose de vrai à offrir. Le participant est invité à apprendre des Muses en développant son talent autant que sa présence, et en acceptant que la reconnaissance soit une conséquence, non un substitut, de la création. Lorsque la séduction est soutenue par la créativité, l’attention devient méritée, inspirante et féconde. Les Muses enseignent que briller n’est pas se montrer pour soi seul, mais éclairer les autres par ce que l’on incarne.",
},
  ...
  "Indépendant->Libre": {
    ...
    conclusion: "Dans la mythologie grecque, Œdipe est avant tout un homme en mouvement. Abandonné à la naissance, il refuse très tôt de rester prisonnier d’un destin imposé sans le questionner. Lorsqu’une prophétie annonce qu’il tuera son père et épousera sa mère, Œdipe ne se soumet pas : il agit. Il quitte Corinthe pour protéger ceux qu’il croit être ses parents et avance seul sur les routes. Plus tard, il affronte la Sphinx par l’intelligence et la détermination, sans attendre l’aide d’autrui. Le mythe d’Œdipe raconte moins une fatalité qu’une trajectoire guidée par des décisions personnelles et un refus de l’immobilité.\n\nLe profil indépendant et libre trouve dans Œdipe une figure profondément cohérente. L’indépendance est centrale : Œdipe décide seul, agit seul et assume seul. Il a confiance en son jugement et préfère trancher plutôt que s’enliser dans des conflits inutiles. Cette autonomie s’accompagne d’un besoin de liberté. Œdipe voyage, quitte les cadres connus et se libère des attaches lorsqu’elles deviennent contraignantes. Comme le participant qui partage ce profil, il croit que la justesse se découvre en avançant, non en restant enfermé dans des règles figées.\n\nPsychologiquement, ce profil repose sur une forte souveraineté intérieure. La personne indépendante-libre a besoin de sentir qu’elle choisit sa route. Elle supporte mal les contraintes arbitraires, les hiérarchies rigides ou les vérités imposées. Elle préfère explorer, comprendre par elle-même et décider selon sa propre boussole. Comme Œdipe face aux énigmes, ce profil aime résoudre seul et avancer avec assurance, quitte à porter pleinement le poids de ses décisions. Éviter les conflits inutiles ne signifie pas fuir la confrontation, mais choisir ses batailles avec lucidité.\n\nLes forces de ce profil sont très visibles dans la vie quotidienne. En amitié, la personne est fiable, autonome et respectueuse de l’espace de chacun. Elle valorise les relations fondées sur la liberté mutuelle plutôt que sur la dépendance. En amour, elle cherche un lien qui respecte l’individualité de chacun, où l’engagement n’annule pas la liberté de mouvement. En carrière, ce profil s’épanouit dans les contextes où l’initiative, l’autonomie et la mobilité sont valorisées : projets indépendants, recherche, entrepreneuriat ou leadership solitaire. Sa capacité à avancer sans attendre donne souvent une impression de grande force intérieure.\n\nCependant, ce profil comporte aussi des fragilités. À force de vouloir tout comprendre et tout décider seul, la personne peut s’isoler. Comme Œdipe poursuivant la vérité sans écouter les avertissements, le profil indépendant-libre peut s’entêter, refuser l’aide ou ignorer les signaux extérieurs. La liberté peut alors se transformer en errance, et l’autonomie en solitude. Le danger n’est pas de chercher la vérité, mais de croire que l’on doit toujours la porter seul.\n\nLa symbolique d’Œdipe est profondément éducative. L’énigme de la Sphinx représente la capacité à penser par soi-même et à affronter l’inconnu sans fuir. Mais l’aveuglement final rappelle une limite essentielle : voir clair ne dépend pas seulement de l’intelligence, mais aussi de l’écoute et de l’humilité. Œdipe montre que la liberté véritable ne consiste pas seulement à avancer, mais à savoir quand s’arrêter et regarder autrement.\n\nLa morale du mythe d’Œdipe invite le participant à trouver un équilibre essentiel. Décider seul est une force, et aimer la liberté est une richesse. Mais l’indépendance ne signifie pas exclusion de l’autre. Le participant est invité à apprendre d’Œdipe en cultivant sa capacité à choisir sans se fermer à l’écoute. En acceptant que certaines vérités se découvrent à plusieurs, la liberté devient plus juste et l’autonomie plus sereine. Œdipe enseigne que l’on peut marcher librement sur sa route, à condition de ne pas confondre solitude et lucidité.",
  },
  "Indépendant->Séducteur": {
    figure: "Daphné",
    image: "images/figures/daphne.png",
    tagline: "Protège sa liberté par la fuite.",
    conclusion: "Dans la mythologie grecque, Daphné est une nymphe associée à la nature, à la liberté et au refus de la contrainte. Son mythe est indissociable de sa fuite devant Apollon, non parce qu’elle méprise l’amour, mais parce qu’elle refuse d’être possédée, définie ou dominée par le désir d’un autre. Daphné court, résiste et choisit. Elle préfère la transformation à la soumission, allant jusqu’à devenir un laurier pour préserver son intégrité. Son histoire ne raconte pas une peur de l’autre, mais une fidélité absolue à soi-même. Daphné incarne une force silencieuse, celle qui sait dire non quand ce non est vital.\n\nLe profil indépendant et séducteur trouve dans Daphné une figure profondément cohérente. L’indépendance est centrale : elle tient à son autonomie, à son espace et à sa liberté intérieure. Elle refuse toute relation fondée sur la domination ou la prise de pouvoir. Pourtant, elle n’est pas invisible. Sa séduction est réelle. Elle attire les regards, éveille l’attention et fascine par sa présence. Mais cette séduction n’est pas une invitation à la possession. Comme le participant qui partage ce profil, Daphné charme sans chercher à appartenir. Elle attire, mais elle choisit.\n\nPsychologiquement, ce profil repose sur une tension féconde entre souveraineté personnelle et rayonnement naturel. La personne indépendante-séductrice a un besoin fort de contrôle sur sa vie et ses décisions. Elle supporte mal la pression, l’intrusion ou les attentes excessives. En même temps, elle dégage un charisme qui capte l’attention sans effort. Cette séduction n’est pas calculée : elle naît de la cohérence intérieure. Comme Daphné, la personne existe d’abord pour elle-même, et c’est précisément ce qui la rend attirante.\n\nLes forces de ce profil apparaissent clairement dans la vie quotidienne. En amitié, la personne est franche, loyale et respectueuse des limites. Elle propose des relations saines, fondées sur le choix mutuel plutôt que sur la dépendance. En amour, elle est magnétique mais exigeante sur le respect, capable d’aimer sans jamais renoncer à son identité. En carrière, ce profil s’épanouit dans les contextes où l’autonomie est valorisée : projets indépendants, création, entrepreneuriat ou leadership personnel. Sa capacité à tracer sa propre voie inspire souvent les autres.\n\nCependant, ce profil comporte aussi des fragilités. Le refus de la domination peut parfois se transformer en méfiance excessive. Comme Daphné fuyant Apollon, la personne peut anticiper le danger là où il n’est pas toujours présent. La séduction devient alors ambivalente : on attire l’autre, mais on redoute ce que cette attraction implique. Le risque est de maintenir une distance constante pour se protéger, au point de limiter la profondeur des liens. Le danger n’est pas l’indépendance, mais l’isolement déguisé en liberté.\n\nLa symbolique de Daphné est profondément éducative. Le laurier représente une transformation choisie, une manière de préserver son essence face à une pression extérieure. Cette image rappelle que l’on peut changer sans se trahir. Elle enseigne aussi que la vraie force n’est pas toujours dans l’affrontement, mais dans la fidélité à soi-même. La séduction de Daphné ne disparaît pas avec sa métamorphose : elle devient symbole, inspiration et présence durable.\n\nLa morale du mythe de Daphné invite le participant à trouver un équilibre essentiel. Vouloir rester libre est une force, et refuser la domination est un droit fondamental. Mais l’indépendance n’exige pas de renoncer au lien. Le participant est invité à apprendre de Daphné en affirmant ses limites sans fuir systématiquement la relation. La séduction peut coexister avec l’autonomie lorsque les liens sont fondés sur le respect plutôt que sur la possession. Daphné enseigne que l’on peut attirer sans se perdre, aimer sans se soumettre et rester libre tout en étant profondément désirable.",
},
  ...
  "Sensible->Leader": {
    ...
    conclusion: "Dans la mythologie grecque, Andromaque est avant tout une figure de fidélité, de courage silencieux et de dignité face à la perte. Épouse d’Hector, héros troyen, elle ne brille pas par les exploits guerriers, mais par la force de son attachement et la lucidité de son regard. Andromaque voit venir la catastrophe avant les autres : elle sait que la guerre de Troie mènera à la mort, à la destruction et à l’effondrement des repères. Pourtant, elle reste debout. Après la mort d’Hector et la chute de Troie, elle survit à l’esclavage, à l’humiliation et à l’arrachement, tout en continuant de protéger ce qui peut l’être. Son mythe raconte moins la victoire que la persévérance morale : celle d’une femme qui continue d’incarner des valeurs humaines quand tout s’écroule autour d’elle.\n\nLe profil sensible et leader trouve dans Andromaque un reflet profond. La sensibilité est au cœur de son identité : elle ressent intensément, aime profondément et souffre sans détour. Ses émotions ne sont jamais superficielles. Elles sont enracinées dans l’empathie, la compassion et le souci des autres. Mais Andromaque n’est pas seulement émotive ; elle agit. Son leadership n’est ni autoritaire ni flamboyant, il est incarné. Elle mène par l’exemple, par la cohérence entre ce qu’elle ressent et ce qu’elle fait. Comme le participant qui partage ce profil, elle croit que les émotions peuvent devenir un moteur d’action et de responsabilité.\n\nPsychologiquement, ce profil repose sur une tension féconde entre le cœur et la structure. La personne sensible-leader perçoit rapidement les besoins, les injustices et les souffrances, et elle ne peut pas rester indifférente. Cette sensibilité crée une forte motivation à agir, à organiser et à guider. Le leadership ne naît pas d’un désir de pouvoir, mais d’un sentiment de devoir. On prend des responsabilités parce qu’on se sent concerné. Comme Andromaque, ce profil cherche à préserver, à protéger et à maintenir une forme d’humanité même dans les contextes difficiles.\n\nLes forces de ce profil sont particulièrement visibles dans la vie quotidienne. En amitié, la personne est profondément loyale, attentive et soutenante. Elle inspire confiance parce qu’elle agit en accord avec ses valeurs. En amour, elle est engagée, protectrice et émotionnellement présente, capable de construire une relation stable fondée sur le respect et le soin mutuel. En carrière, elle excelle dans les rôles où l’organisation, la responsabilité et l’humain doivent coexister : coordination, enseignement, gestion d’équipe, accompagnement. Ce profil est capable de faire avancer les choses sans écraser les autres, en donnant du sens à l’action collective.\n\nCependant, ces mêmes qualités comportent des fragilités importantes. La sensibilité peut devenir un poids lorsque la personne absorbe trop les émotions des autres. Elle peut se sentir responsable du bien-être de tous, au détriment du sien. Le leadership, lorsqu’il est nourri par l’émotion, peut conduire à l’épuisement : on veut réparer, protéger et porter, parfois sans limites. Comme Andromaque, la personne risque de continuer à tenir même quand tout s’effondre, sans s’autoriser à déposer le fardeau. Le danger n’est pas la faiblesse, mais l’oubli de soi.\n\nLa symbolique d’Andromaque est profondément éducative. Elle incarne la force morale, celle qui ne repose ni sur la domination ni sur la victoire, mais sur la fidélité à ses valeurs. Elle montre que diriger ne signifie pas imposer, mais tenir un cap humain. Cependant, son histoire rappelle aussi que la dignité silencieuse peut devenir une prison si elle empêche de demander de l’aide ou de reconnaître ses limites. La compassion doit s’inclure soi-même pour rester vivante.\n\nLa morale du mythe d’Andromaque invite le participant à un rééquilibrage essentiel. Ressentir intensément est une force, mais cette force doit être soutenue par des frontières claires. Diriger par l’exemple est puissant, mais nul ne peut porter seul le poids du monde. Le participant est invité à reconnaître que prendre soin de soi n’est pas une trahison de ses valeurs, mais une condition pour continuer à guider les autres. En apprenant à partager la responsabilité émotionnelle, à déléguer et à s’accorder du repos, la sensibilité devient une sagesse et le leadership, une force durable. Andromaque enseigne que l’on peut rester profondément humain tout en avançant, à condition de ne pas s’oublier en chemin.",
  },
  "Sensible->Combattant": {
    figure: "Iphigénie",
    image: "images/figures/iphigenie.png",
    tagline: "Émotion qui pousse à agir : défend par attachement, colère ou amour.",
    conclusion: "Dans la mythologie grecque, Iphigénie est une figure profondément marquante parce que son courage ne naît pas de la violence, mais de l’empathie. Fille d’Agamemnon, elle est conduite au camp grec sous un mensonge, croyant être promise à un mariage alors qu’elle est destinée au sacrifice. Lorsqu’elle comprend la vérité, Iphigénie ne fuit pas et ne se révolte pas. Elle écoute, observe et ressent la peur, l’attente et la détresse de toute une armée immobilisée. Son choix d’accepter le sacrifice ne vient pas d’un désir de mourir, mais d’un acte conscient : agir pour mettre fin à la souffrance collective. Son mythe raconte un courage rare, celui qui transforme la compassion en action décisive.\n\nLe profil sensible et combattant trouve dans Iphigénie une incarnation puissante. Sa sensibilité se manifeste dans sa capacité à ressentir profondément les émotions des autres et à comprendre les enjeux humains derrière les décisions difficiles. Elle perçoit la peur des soldats, la pression qui pèse sur son père et l’urgence de la situation. Mais cette sensibilité ne la paralyse pas. Elle devient le moteur de son engagement. Combattante, Iphigénie n’hésite pas à agir lorsque le moment l’exige, même si l’action demande un immense courage intérieur.\n\nPsychologiquement, ce profil repose sur une alliance forte entre empathie et détermination. La personne sensible-combattante ressent intensément, mais refuse de rester passive face à la souffrance. Elle agit non par impulsivité, mais par responsabilité émotionnelle. Elle est capable d’assumer des choix lourds parce qu’elle en comprend le sens. Comme Iphigénie, ce profil sait se lever dans les moments critiques, là où d’autres hésitent ou reculent.\n\nLes forces de ce profil apparaissent clairement dans la vie quotidienne. En amitié, la personne est attentive, loyale et prête à agir concrètement pour aider. Elle ne se contente pas d’écouter, elle intervient. En amour, elle est engagée, courageuse et protectrice, capable de prendre des décisions difficiles pour préserver l’équilibre du couple. En carrière, ce profil excelle dans les contextes où il faut agir sous pression, défendre des valeurs ou assumer des responsabilités importantes. On peut compter sur elle lorsque la situation devient complexe ou urgente.\n\nCependant, ces qualités comportent aussi des fragilités. La tendance à agir pour les autres peut mener à l’oubli de soi. Comme Iphigénie acceptant le sacrifice, la personne sensible-combattante peut se mettre en danger émotionnel ou physique en portant trop de responsabilités. Elle peut avoir du mal à dire non, à se protéger ou à reconnaître ses propres limites. Le danger n’est pas le courage, mais le sacrifice excessif lorsqu’il devient une habitude plutôt qu’un choix conscient.\n\nLa symbolique d’Iphigénie est profondément éducative. Elle incarne le courage du cœur, celui qui agit non par désir de gloire, mais par souci des autres. Son sacrifice représente la capacité de transformer l’empathie en action. Mais son mythe rappelle aussi une vérité essentielle : toute action héroïque doit être choisie, non imposée. Le courage véritable ne consiste pas à se sacrifier systématiquement, mais à savoir quand agir et quand se préserver.\n\nLa morale du mythe d’Iphigénie invite le participant à trouver un équilibre fondamental. Être sensible est une force immense, et agir avec courage peut changer les choses. Mais le combat ne doit pas toujours passer par le renoncement à soi. Le participant est invité à apprendre d’Iphigénie en honorant sa capacité à agir tout en protégeant sa propre valeur. En transformant la combativité en engagement juste plutôt qu’en sacrifice permanent, la sensibilité devient une boussole morale et l’action, une force constructive. Iphigénie enseigne que le courage le plus puissant est celui qui agit pour le bien commun sans s’oublier soi-même.",
  },
  "Sensible->Créatif": {
    figure: "Orphée",
    image: "images/figures/orphee.png",
    tagline: "Les émotions fortes donnent à l'art son âme.",
    conclusion: "Dans la mythologie grecque, Orphée est un musicien dont l’art est indissociable de sa vie émotionnelle. Sa lyre n’est pas un simple instrument, mais le prolongement direct de son cœur. Lorsqu’Orphée joue, le monde réagit : les animaux s’apaisent, la nature s’incline, les humains écoutent et même les dieux suspendent leur jugement. Cette puissance ne vient pas d’une technique froide ni d’une volonté de domination, mais de ce qu’il ressent profondément. Sa musique naît de l’amour, de la joie, du manque et de la douleur. Elle l’accompagne dans toutes les circonstances, comme une voix intérieure capable de transformer chaque émotion en création.\n\nLe profil sensible et créatif trouve en Orphée une figure essentielle. Sa sensibilité est un canal ouvert : il ressent tout avec intensité et écoute son cœur avant toute chose. Chaque émotion vécue devient une source d’inspiration. La créativité n’est pas pour lui un choix stratégique, mais une nécessité vitale. Orphée crée parce qu’il ressent trop pour rester silencieux. Comme le participant qui partage ce profil, il ne sépare jamais ce qu’il vit de ce qu’il exprime. Ses émotions ne freinent pas son talent, elles le nourrissent et lui donnent sa profondeur.\n\nPsychologiquement, ce profil repose sur une résonance émotionnelle très forte. La personne sensible-créative est profondément touchée par ce qu’elle vit et par ce qui l’entoure. Elle perçoit les nuances, les atmosphères et les états d’âme avec finesse. Cette intensité émotionnelle peut parfois sembler excessive, mais elle constitue en réalité un immense potentiel créatif. Chez Orphée, chaque émotion devient musique. La joie élève son art, tandis que la tristesse l’approfondit. La création agit comme un soutien intérieur : lorsque la douleur devient trop lourde, la musique l’empêche de s’effondrer en lui donnant une forme et un sens.\n\nLes forces de ce profil apparaissent clairement dans la vie quotidienne. En amitié, la personne est attentive, expressive et profondément empathique. Elle comprend les autres parce qu’elle ressent intensément. En amour, elle est sincère, passionnée et engagée, capable de créer des liens émotionnels forts. En carrière, ce profil s’épanouit dans les domaines artistiques, créatifs ou culturels, mais aussi partout où l’émotion peut devenir un levier d’influence et de sens. Comme Orphée charmant ceux qui l’écoutent, cette personne sait toucher, inspirer et rassembler par son authenticité.\n\nCependant, cette sensibilité comporte aussi des fragilités. Ressentir fortement expose à la souffrance. Lorsque Orphée perd Eurydice, son chagrin est immense. Sa musique devient alors à la fois un refuge et un rappel douloureux de l’absence. Le profil sensible-créatif peut parfois se laisser submerger par ses émotions, douter de lui-même ou craindre que la tristesse étouffe son talent. Le danger n’est pas l’émotion, mais le fait de la subir sans la transformer.\n\nLa symbolique d’Orphée est profondément éducative. Sa lyre représente la capacité de transformer toutes les émotions en création, sans distinction entre bonheur et douleur. La musique ne sert pas seulement à séduire ou à influencer les autres ; elle soutient Orphée dans ses moments les plus sombres. Elle est à la fois un pont vers les autres et un appui intérieur. Même aux Enfers, sa musique trouve un écho. Cette image rappelle que l’art né de la sensibilité peut accompagner l’individu dans toutes les épreuves.\n\nLa morale du mythe d’Orphée invite le participant à reconnaître la valeur de sa sensibilité. Ressentir intensément n’est pas une faiblesse, mais un cadeau pour l’artiste. Les émotions, même difficiles, nourrissent la créativité et lui donnent sa profondeur. Le participant est invité à cesser de lutter contre ce qu’il ressent et à l’utiliser comme une ressource. En acceptant que la joie comme la tristesse enrichissent le talent, la création devient un chemin de résilience. Orphée enseigne que lorsque l’on écoute son cœur et que l’on transforme l’émotion en art, même la douleur peut devenir source de beauté et de sens.",
  },
  "Sensible->Protecteur": {
    figure: "Thétis",
    image: "images/figures/thetis.png",
    tagline: "Tente d’épargner la souffrance et le destin.",
    conclusion: "Dans la mythologie grecque, Thétis est une nymphe marine, figure maternelle puissante et tragique. Elle n’est ni reine ni déesse toute-puissante, mais elle possède une conscience aiguë du destin. Dès la naissance de son fils Achille, Thétis sait ce qui l’attend : une gloire immense, mais une mort certaine et précoce. Toute son histoire est marquée par cette connaissance douloureuse. Elle tente de contourner la fatalité, de protéger son enfant, de le rendre invulnérable, de le cacher et de retarder l’inévitable. Le mythe de Thétis n’est pas celui de la victoire sur le destin, mais celui d’un amour si profond qu’il refuse de se résigner à la souffrance annoncée.\n\nLe profil sensible et protecteur trouve dans Thétis une incarnation bouleversante. La sensibilité se manifeste dans sa capacité à ressentir intensément la douleur à venir, à anticiper la peine et à compatir profondément avec ceux qu’elle aime. Thétis ressent avant même que la blessure n’existe. Elle écoute son cœur, ses pressentiments et ses émotions. Son instinct protecteur naît directement de cette sensibilité : aimer, pour elle, signifie préserver, épargner et mettre à l’abri. Comme le participant qui partage ce profil, Thétis ne supporte pas l’idée de voir souffrir ceux auxquels elle est attachée.\n\nPsychologiquement, ce profil repose sur une vigilance émotionnelle très forte. La personne sensible-protectrice perçoit rapidement les dangers, les fragilités et les menaces, qu’elles soient réelles ou potentielles. Elle se sent naturellement responsable du bien-être des autres, surtout de ceux qu’elle aime. Protéger devient une manière d’aimer, parfois même une manière d’exister. Comme Thétis, ce profil agit souvent en amont, cherchant à prévenir plutôt qu’à réparer. Cependant, cette anticipation constante peut devenir lourde, car elle place la personne dans une tension permanente entre amour et peur.\n\nLes forces de ce profil sont immenses dans la vie quotidienne. En amitié, la personne est attentive, loyale et profondément engagée. Elle sait écouter, rassurer et soutenir dans les moments difficiles. En amour, elle est dévouée, protectrice et émotionnellement présente, offrant un sentiment de sécurité rare. En carrière, ce profil s’épanouit dans les rôles où le soin, l’accompagnement, la prévention et la responsabilité sont essentiels. Il excelle lorsqu’il peut veiller, encadrer, soutenir et anticiper les besoins des autres. Cette capacité à protéger est une véritable force humaine et sociale.\n\nCependant, ces qualités comportent aussi des fragilités importantes. À force de vouloir éviter la souffrance, la personne peut tomber dans le contrôle excessif. Comme Thétis cherchant à détourner le destin d’Achille, le profil sensible-protecteur peut vouloir décider à la place de l’autre, empêcher les expériences difficiles ou nier la réalité de certaines épreuves. Le danger n’est pas l’amour, mais la confusion entre protéger et empêcher de vivre. Ce profil peut aussi s’épuiser émotionnellement en portant des peurs qui ne lui appartiennent pas toujours.\n\nLa symbolique de Thétis est profondément éducative. Elle représente l’amour qui lutte contre l’inéluctable, la tendresse face à la fatalité. Mais son mythe rappelle aussi une vérité essentielle : on ne peut pas abolir toute souffrance sans abolir une part de la vie. Immerger Achille dans le Styx ne suffit pas à le sauver. Cette image invite le participant à réfléchir à ses propres limites, protéger ne signifie pas rendre invulnérable, mais accompagner avec lucidité.\n\nLa morale du mythe de Thétis invite à un rééquilibrage profond. Ressentir intensément est une force, mais cette force doit être accompagnée d’un lâcher-prise conscient. Aimer, ce n’est pas empêcher toute douleur, mais être présent quand elle survient. Le participant est invité à apprendre de Thétis en transformant la protection en soutien plutôt qu’en contrôle. En acceptant que certaines expériences sont nécessaires à la croissance, la sensibilité devient compassion et la protection devient guidance. Thétis enseigne que l’on peut aimer profondément sans se perdre dans la peur du destin et que la véritable protection consiste parfois à laisser l’autre vivre tout en restant à ses côtés.",
  },
  "Sensible->Séducteur": {
    figure: "Psyché",
    image: "images/figures/psyche.png",
    tagline: "Vulnérabilité, confiance, besoin d’être aimée.",
    conclusion: "Dans la mythologie grecque, Psyché est une mortelle dont la beauté attire tous les regards, mais dont l’histoire est avant tout intérieure. Admirée, désirée et enviée, elle semble promise à une vie exceptionnelle, et pourtant elle souffre d’un décalage profond entre ce que les autres projettent sur elle et ce qu’elle ressent réellement. Son union secrète avec Éros l’oblige à aimer sans voir, à faire confiance à son cœur plutôt qu’aux apparences. Lorsque Psyché cède au doute et cherche à comprendre, elle perd ce qu’elle aime et doit traverser une série d’épreuves pour se retrouver. Son mythe raconte la découverte progressive de soi à travers l’émotion, la relation et le regard de l’autre.\n\nLe profil sensible et séducteur trouve dans Psyché une incarnation profondément juste. Sa sensibilité est au cœur de son parcours : Psyché ressent intensément, aime sincèrement et doute profondément. Elle mène sa vie guidée par ses émotions, parfois malgré elle, même lorsqu’elle rêvait d’un destin différent. Mais Psyché est aussi séductrice au sens psychologique : elle existe à travers le lien, le regard et la reconnaissance. Elle puise son énergie dans la relation aux autres. Comme le participant qui partage ce profil, Psyché se construit dans l’échange et la connexion.\n\nPsychologiquement, ce profil repose sur une grande ouverture émotionnelle et relationnelle. La personne sensible-séductrice ressent fortement et exprime naturellement ce qu’elle vit. Elle est souvent expressive, chaleureuse et touchante. Elle attire sans calcul, par authenticité émotionnelle. Son profil est tourné vers l’extérieur et se recharge au contact des autres. Le regard, l’écoute et la validation nourrissent son énergie vitale, mais cette dépendance peut aussi fragiliser l’estime de soi.\n\nLes forces de ce profil sont évidentes dans la vie quotidienne. En amitié, la personne est investie, vivante et capable de créer des liens profonds. Elle apporte chaleur, émotion et présence. En amour, elle est passionnée, expressive et engagée, cherchant une relation où l’échange émotionnel est central. En carrière, ce profil s’épanouit dans les contextes relationnels. Sa capacité à toucher et à mobiliser les autres est une force collective.\n\nCependant, ces qualités comportent aussi des fragilités importantes. Le besoin d’être vue et reconnue peut rendre la personne dépendante du regard extérieur. Comme Psyché doutant de l’amour d’Éros, le profil sensible-séducteur peut craindre de ne pas être assez ou de perdre l’attention d'une personne précieuse. Il peut se suradapter, trop donner ou se définir à travers l’approbation des autres. La sensibilité amplifie alors les blessures relationnelles. Le danger n’est pas la relation, mais l’oubli de sa valeur personnelle.\n\nLa symbolique de Psyché est profondément éducative. Son nom signifie « âme ». Elle incarne la rencontre entre le désir d’être aimé et la nécessité de se reconnaître soi-même. Les épreuves qu’elle traverse ne la punissent pas, elles la construisent. Psyché apprend que voir et être vue ne suffit pas : il faut aussi se faire confiance et écouter son cœur sans se perdre dans l’attente de validation.\n\nLa morale du mythe de Psyché invite le participant à une intégration essentielle. Ressentir intensément et aimer le lien est une force, mais cette force doit s’ancrer dans une reconnaissance intérieure. Être nourri par les autres ne signifie pas dépendre d’eux pour exister. Le participant est invité à apprendre de Psyché en développant une estime de soi stable, capable de résister à l’absence de regard extérieur. En équilibrant sensibilité et affirmation personnelle, l’émotion devient une richesse et la séduction, un partage authentique. Psyché enseigne que l’on peut briller dans la relation tout en restant profondément fidèle à soi-même.",
  },
  "Sensible->Libre": {
    figure: "Ariane",
    image: "images/figures/arine.png",
    tagline: "Suit l’amour et l’intuition.",
    conclusion: "Dans la mythologie grecque, Ariane est une figure profondément liée au choix du cœur et au courage de suivre son intuition. Fille du roi Minos, elle vit au cœur du labyrinthe de Crète, symbole de règles, de contraintes et de destins imposés. Lorsqu’elle rencontre Thésée, elle ne se contente pas d’obéir à l’ordre établi. Elle ressent, comprend et agit. En lui offrant le fil qui lui permettra de sortir du labyrinthe, Ariane ne sauve pas seulement un héros : elle affirme sa capacité à écouter son intuition et à choisir l’amour, même si cela implique de rompre avec son monde d’origine. Son mythe est celui d’un passage, quitter ce qui enferme pour suivre ce qui appelle intérieurement.\n\nLe profil sensible et libre trouve dans Ariane un miroir puissant. La sensibilité se manifeste dans sa capacité à ressentir profondément, à percevoir les émotions de l’autre et à se laisser toucher sincèrement. Ariane agit par empathie, par attachement, par écoute du cœur. Mais elle est aussi libre : elle refuse de rester enfermée dans un rôle prédéfini. Elle ose l’inconnu, l’aventure et le mouvement. Comme le participant qui partage ce profil, Ariane ne suit pas une ligne droite imposée ; elle suit ce qui résonne intérieurement, même si le chemin est incertain.\n\nPsychologiquement, ce profil repose sur une grande réceptivité émotionnelle combinée à un besoin fondamental de liberté. La personne sensible-libre ressent intensément et se connecte facilement aux autres. Elle comprend, devine et soutient. Mais elle a aussi besoin d’espace pour explorer, improviser et découvrir. Les cadres trop rigides, les relations étouffantes ou les chemins tracés d’avance lui donnent l’impression de perdre son souffle. Comme Ariane quittant le palais, ce profil cherche à se sentir vivant et aligné avec ses élans intérieurs plutôt qu’avec des attentes extérieures.\n\nLes forces de ce profil sont riches et précieuses dans la vie quotidienne. En amitié, la personne est chaleureuse, attentive et profondément empathique. Elle offre une présence sincère, capable d’écouter sans juger. En amour, elle est passionnée, intuitive et généreuse, capable de créer une connexion authentique fondée sur la liberté mutuelle. En carrière, ce profil s’épanouit dans des environnements où la créativité, l’autonomie et l’exploration sont valorisées. Il excelle lorsqu’il peut suivre son intuition, proposer des idées nouvelles et tracer des chemins originaux.\n\nCependant, ces qualités comportent aussi des zones de fragilité. La sensibilité peut rendre la personne vulnérable aux déceptions affectives. Comme Ariane abandonnée par Thésée, ce profil peut souffrir intensément lorsqu’il donne beaucoup et se sent oublié ou trahi. Le besoin de liberté peut également créer de l’instabilité, avec une difficulté à s’engager durablement ou une tendance à fuir lorsque la relation ou le projet devient trop contraignant. L’improvisation constante peut parfois remplacer la construction patiente.\n\nLa symbolique d’Ariane est profondément éducative. Le fil qu’elle offre n’est pas seulement un outil pour sortir du labyrinthe : il représente la connexion entre intuition et direction. Suivre son cœur ne signifie pas se perdre. La liberté véritable n’est pas l’absence de liens, mais la capacité de choisir consciemment ses attaches. Ariane montre que l’on peut aimer, ressentir et aider sans s’effacer, à condition de rester relié à soi-même.\n\nLa morale du mythe d’Ariane invite le participant à une intégration essentielle. Écouter son cœur est une force, mais cette écoute doit aussi s’accompagner d’un ancrage intérieur. Être libre ne signifie pas être constamment en mouvement, mais être fidèle à ce qui fait sens. Le participant est invité à apprendre d’Ariane en cultivant la confiance en son intuition tout en développant la capacité à se choisir lui-même. En trouvant l’équilibre entre ouverture émotionnelle et liberté personnelle, la sensibilité devient une boussole et la liberté, un espace de création durable. Ariane enseigne que suivre l’amour et l’intuition est un chemin puissant, à condition de ne pas s’y oublier soi-même.",
  },
  "Sensible->Indépendant": {
    figure: "Niobé",
     image: "images/figures/niobe.png",
    tagline: "Fierté solitaire.",
    conclusion: "Dans la mythologie grecque, Niobé est une reine puissante, mère nombreuse, consciente de sa valeur et de ce qu’elle a construit. Elle incarne une figure profondément humaine : aimante, protectrice, mais aussi vulnérable. En se comparant à la déesse Léto, Niobé n’exprime pas seulement de l’orgueil, mais surtout l’importance qu’elle accorde à ce qui lui est cher. Lorsque ses enfants sont frappés par Apollon et Artémis, sa douleur devient absolue. Incapable de contenir ce chagrin immense, Niobé se fige et se transforme en pierre, tout en continuant de pleurer. Son mythe raconte moins une punition qu’un débordement émotionnel devenu insoutenable, une sensibilité si profonde qu’elle se replie sur elle-même pour survivre.\n\nLe profil sensible et indépendant trouve dans Niobé un reflet puissant. Être sensible signifie ressentir intensément les émotions, les siennes comme celles des autres, percevoir ce qui n’est pas toujours exprimé. Niobé aime profondément, et c’est précisément cette capacité d’attachement qui la rend vulnérable. Son indépendance, quant à elle, se manifeste dans son silence et sa retenue. Elle ne cherche pas à se justifier ni à exposer sa souffrance. Comme le participant qui partage ce profil, Niobé vit beaucoup à l’intérieur et préfère porter seule ce qu’elle ressent plutôt que de s’exposer.\n\nLes qualités de ce profil sont précieuses. Une personne sensible et indépendante possède une grande empathie, une écoute naturelle et une compréhension fine des autres. Elle est loyale, sincère et profondément attachée à ce qu’elle aime. Son indépendance lui permet de réfléchir seule, de prendre du recul et de ne pas se laisser entraîner par les émotions collectives. Elle offre souvent une présence discrète mais solide, capable de soutenir sans envahir. Comme Niobé reine, ce profil est digne, intériorisé et animé par une vie émotionnelle riche.\n\nCependant, ces qualités comportent aussi des fragilités. La sensibilité, lorsqu’elle n’est pas exprimée, peut devenir un poids émotionnel écrasant. À l’image de Niobé, la personne peut accumuler la douleur, la tristesse ou la culpabilité jusqu’à se refermer. L’indépendance peut alors se transformer en isolement : on souffre seul, on ne demande pas d’aide, par pudeur ou par peur de déranger. Ce profil risque de se figer émotionnellement, non par froideur, mais par mécanisme de protection.\n\nLa symbolique de Niobé est essentielle pour comprendre ce fonctionnement. La pierre n’est pas seulement un châtiment, mais un refuge. En se transformant en statue, Niobé cesse d’agir, mais elle continue de ressentir. Les larmes coulent toujours. Cette image rappelle que bloquer ses émotions ne les efface pas ; elle les rend silencieuses et durables. Pour le participant, cette symbolique invite à reconnaître ses émotions sans les nier ni les laisser s’accumuler jusqu’à l’immobilité intérieure.\n\nLa morale du mythe de Niobé est profondément éducative. Elle enseigne que la sensibilité est une force, mais qu’elle doit être accompagnée. Ressentir intensément ne signifie pas tout porter seul. L’indépendance n’est pas l’isolement, mais la capacité de choisir quand s’ouvrir et à qui. Le participant est invité à apprendre de Niobé en trouvant l’équilibre entre intériorité et partage. En acceptant de nommer ses émotions et de demander du soutien lorsque nécessaire, la sensibilité devient une source de sagesse et l’indépendance, une force paisible plutôt qu’un refuge silencieux.",
  },
};
